...
class MistralClient(LLMClient):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        try:
            ...
            raise ImportError(
                "mistralai package is required for Mistral models. Please install it (e.g., pip install mistralai)."
            )
    ...
    def generate(self, messages: list, **kwargs) -> str:
        ...
        try:
            ...
            response = self.client.chat.complete(
                model=self.model, messages=processed_messages, **params
            )
...
class GeminiClient(LLMClient):
    ...
    def generate(self, messages: list, **kwargs) -> str:
        ...
        try:
            ...
            model = self.genai.GenerativeModel(model_name=self.model, **model_kwargs)

            response = model.generate_content(
                contents=gemini_messages_for_api, generation_config=generation_config
            )
